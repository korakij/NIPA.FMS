...
namespace MNG.Services.Migrations
{
    ...
    [Migration("20190312163954_CreateLotNoModel5")]
    partial class CreateLotNoModel5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MNG.Models.Productions.LotNo", b =>
                {
                    ...
                    b.HasIndex("FurnaceCode")
                        .IsUnique()
                        .HasFilter("[FurnaceCode] IS NOT NULL");
            ...
            modelBuilder.Entity("MNG.Models.Productions.Charging", b =>
                {
                    b.HasOne("MNG.Models.Productions.LotNo")
                        .WithMany("Chargings")
            ...
            modelBuilder.Entity("MNG.Models.Productions.LotNo", b =>
                {
                    b.HasOne("MNG.Models.Productions.Furnace", "Furnace")
                        .WithOne()
                        .HasForeignKey("MNG.Models.Productions.LotNo", "FurnaceCode");
                });

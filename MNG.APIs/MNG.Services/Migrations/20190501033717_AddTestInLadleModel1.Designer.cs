...
namespace MNG.Services.Migrations
{
    ...
    [Migration("20190501033717_AddTestInLadleModel1")]
    partial class AddTestInLadleModel1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MNG.Models.Productions.TestChemInLadle", b =>
                {
                    b.Property<string>("Code")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20);
            ...
            modelBuilder.Entity("MNG.Models.Productions.TestChemInLadle", b =>
                {
                    b.HasOne("MNG.Models.Productions.Kanban", "Kanbans")
                        .WithMany("TestKanbans")
                    ...
                    b.OwnsOne("MNG.Models.Productions.ChemicalComposition", "Result", b1 =>
                        {
                            b1.Property<string>("TestChemInLadleCode");
                            ...
                            b1.ToTable("TestChemInLadle");

                            b1.HasOne("MNG.Models.Productions.TestChemInLadle")
                                .WithOne("Result")
                                .HasForeignKey("MNG.Models.Productions.ChemicalComposition", "TestChemInLadleCode")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                    ...
                    b.OwnsOne("MNG.Models.Productions.ChemicalCompositionValidation", "Validation", b1 =>
                        {
                            ...
                            b1.HasOne("MNG.Models.Productions.TestChemInLadle")
                                .WithOne("Validation")
                                .HasForeignKey("MNG.Models.Productions.ChemicalCompositionValidation", "TestChemInLadleCode")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });

...
namespace MNG.Services.Migrations
{
    ...
    [Migration("20200315171504_Update20031601")]
    partial class Update20031601
    {
            ...
            modelBuilder.Entity("MNG.Models.Productions.Pouring", b =>
                {
                    ...
                    b.OwnsOne("MNG.Models.Productions.Defects.MeltingDefect", "MeltDefect", b1 =>
                        {
                            b1.Property<string>("PouringCode");

                            b1.Property<int>("BlowHole");

                            b1.Property<int>("ChemNG");

                            b1.Property<int>("Chill");

                            b1.Property<int>("HardnessNG");

                            b1.Property<int>("MicroNG");

                            b1.Property<int>("PinHole");

                            b1.Property<int>("Shrinkage");

                            b1.ToTable("Pourings");

                            b1.HasOne("MNG.Models.Productions.Pouring")
                                .WithOne("MeltDefect")
                                .HasForeignKey("MNG.Models.Productions.Defects.MeltingDefect", "PouringCode")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
